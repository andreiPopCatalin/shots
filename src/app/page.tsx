  ...
  return (
    ...
    <div className="flex justify-center space-x-1 pt-3">
      ...
      <div className="relative group">
        ...
        {/* Tooltip */}
        <div className="absolute max-w-[100px] w-[100px] top-full left-1/2 transform -translate-x-1/2 mt-2 px-2 py-2 bg-[#2C2C2E] text-white text-sm rounded-lg opacity-0 group-hover:opacity-100 transition-opacity">
      ...
      <div className="relative group">
        ...
        <div className="absolute max-w-[120px] w-[120px]  top-full left-1/2 transform -translate-x-1/2 mt-2 px-2 py-1 bg-[#2C2C2E] text-white text-sm rounded opacity-0 group-hover:opacity-100 transition-opacity">
      ...
      <div className="relative group">
        ...
        <div className="absolute top-full left-1/2 transform -translate-x-1/2 mt-2 px-2 py-1 bg-[#2C2C2E] text-white text-sm rounded opacity-0 group-hover:opacity-100 transition-opacity">
            Preview
        </div>
      </div>
    </div>
